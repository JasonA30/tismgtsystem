...
public class student {
            ...
            
    {
        ...
        {
            int YesOrNo = JOptionPane.showConfirmDialog(null, "The Final Grade will be also be deleted, Are you sure you want to continue?", "Delete Student", JOptionPane.OK_CANCEL_OPTION, 0);
