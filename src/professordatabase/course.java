...
public class course {
     ...
     public void insertUpdateDeleteStudent(char operation, Integer id, String coursecode, Integer hours)
            
    {
        ...
        {
            int YesOrNo = JOptionPane.showConfirmDialog(null, "The Final Grade will be also be deleted, Are you sure you want to continue?", "Delete Grade", JOptionPane.OK_CANCEL_OPTION, 0);
